...
public class GamePanel extends JPanel implements Runnable {
    ...
    Rectangle exitBtn     = new Rectangle(screenWidth - 130, 20, 100, 34);
    ...
    void exitToMenu() {
        gameState = STATE_MENU;
        keysPressed.clear();
        playButton = new Rectangle(screenWidth / 2 - 110, screenHeight / 2 + 10, 220, 52);
        repaint();
    }
    ...
    void handleHover(Point p) {
        ...
        boolean anyHover = hoveringPlay || hoveringControls || hoveringQuit || hovering60 || hovering99
    ...
    protected void paintComponent(Graphics g) {
        ...
        switch (gameState) {
            ...
            case STATE_GAMEOVER -> renderer.drawGameOver(g2, player1, player2, gameStateObj,
                                        playButton, hoveringPlay, timerFrames, timerInfinite, FPS,
